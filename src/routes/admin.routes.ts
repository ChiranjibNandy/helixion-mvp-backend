...
import { approveUser, getPendingRegistrations, deactivateUser, batchCreateUsers, searchUsers } from "../controllers/admin.controller.js";
import { approveUserBodySchema, approveUserParamsSchema, pendingRegistrationsQuerySchema, batchCreateUsersBodySchema, searchUsersQuerySchema } from "../validators/admin.validator.js";
